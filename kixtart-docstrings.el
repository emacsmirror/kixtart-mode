...
(kixtart-doc-register kixtart-make-doc-macro
  ...
  (@HOMEDIR :description "Short name of the directory part of the home directory" :type 8 :final t)
  (@HOMEDRIVE :description "Drive letter of drive containing the home directory" :type 8 :final t)
  (@HOMESHR :description "Server and share name part of the home directory" :type 8 :final t)
  ...
  (@LONGHOMEDIR :description "Long name of the directory part of the home directory" :type 8 :final t)
  ...
  (@RESULT :description "Returns command specific information (e.g. the drive letter of an automatic redirection command)" :type 8 :final t)
